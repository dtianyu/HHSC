 ...
 * @author kevindong
 */
@ManagedBean(name = "itemPurchaseManagedBean")
@SessionScoped
public class ItemPurchaseManagedBean extends SuperMulti2Bean<ItemMaster, ItemMake, VendorItem> {
    ...
    public ItemPurchaseManagedBean() {
