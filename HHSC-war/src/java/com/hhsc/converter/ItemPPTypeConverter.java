 ...
 * @author kevindong
 */
@FacesConverter("itemPPTypeConverter")
public class ItemPPTypeConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if (value.trim().equals("")) {
            ...
            try {
                ItemPPType entity = itemPPTypeBean.findById(value);
                if (entity != null) {
                    return entity;
                } else {
                    return null;
