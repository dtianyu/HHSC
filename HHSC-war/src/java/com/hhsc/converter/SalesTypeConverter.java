 ...
 * @author kevindong
 */
@FacesConverter("salesTypeConverter")
public class SalesTypeConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if (value.trim().equals("")) {
            ...
            try {
                SalesType entity = salesTypeBean.findById(Integer.parseInt(value));
                if (entity != null) {
                    return entity;
                } else {
                    return null;
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return ((SalesType) value).getId().toString();
        }
    }
