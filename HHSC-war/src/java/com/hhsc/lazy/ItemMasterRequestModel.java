 ...
 * @author kevindong
 */
public class ItemMasterRequestModel extends BaseLazyModel<PurchaseRequest> {

    public ItemMasterRequestModel(SuperEJB superEJB) {
    ...
    public List<PurchaseRequest> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        ...
        this.filterFields.put("purtype", "300");
