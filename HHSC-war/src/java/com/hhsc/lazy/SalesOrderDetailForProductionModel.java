 ...
 * @author kevindong
 */
public class SalesOrderDetailForProductionModel extends BaseLazyModel<SalesOrderDetailForQuery> {

    public SalesOrderDetailForProductionModel(SuperEJB superEJB) {
