...
public class VendorItem extends SuperDetailEntity {
    ...
    @Size(max = 45)
    @Column(name = "vendoritemcolor")
    private String vendoritemcolor;
    @Size(max = 45)
    @Column(name = "vendorcontacter")
    ...
    public String getVendoritemcolor() {
        return vendoritemcolor;
    }

    public void setVendoritemcolor(String vendoritemcolor) {
        this.vendoritemcolor = vendoritemcolor;
    }

    public String getVendorcontacter() {
        return vendorcontacter;
    }

    public void setVendorcontacter(String vendorcontacter) {
        this.vendorcontacter = vendorcontacter;
    }
