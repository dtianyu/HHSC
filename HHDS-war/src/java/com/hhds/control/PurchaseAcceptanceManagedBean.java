...
import com.hhds.ejb.PurchaseAcceptanceBean;
import com.hhds.ejb.PurchaseAcceptanceDetailBean;
...
import com.hhds.lazy.PurchaseAcceptanceModel;
...
public class PurchaseAcceptanceManagedBean extends FormMultiBean<PurchaseAcceptance, PurchaseAcceptanceDetail> {
    ...
    protected boolean doBeforeUnverify() throws Exception {
        ...
        for (PurchaseAcceptanceDetail detail : detailList) {
            ...
            //    return false;
            //}
            String colorno = detail.getColorno() == null ? detail.getVendorcolorno() : detail.getColorno();
            String batch = detail.getVendoritemno() != null ? detail.getVendoritemno() : detail.getBatch();
            ItemInventory i = itemInventoryBean.findItemInventory(detail.getItemno(), colorno, detail.getBrand(), batch, detail.getSn(), detail.getWarehouse().getWarehouseno());
    ...
    public void doConfirmDetail() {
        this.currentDetail.setQcqty(this.currentDetail.getQty());
    ...
    public void handleDialogReturnWhenDetailEdit(SelectEvent event) {
        ...
        if (event.getObject() != null) {
            ...
            this.currentDetail.setPurtype(detail.getPurchaseOrder().getFormtype());
            this.currentDetail.setPurkind(detail.getPurchaseOrder().getFormkind());
