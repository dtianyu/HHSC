...
public class InvoiceDetailForQuery extends BaseEntity {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvoiceDetailForQuery)) {
            return false;
        }
        InvoiceDetailForQuery other = (InvoiceDetailForQuery) object;
    ...
    /**
     * @param salesInvoice the invoice to set
     */
    public void setInvoice(Invoice salesInvoice) {
