...
public class PurchaseOrderDetailForStorage extends BaseEntity {
    ...
    public PurchaseOrderDetailForStorage() {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PurchaseOrderDetailForStorage)) {
            return false;
        }
        PurchaseOrderDetailForStorage other = (PurchaseOrderDetailForStorage) object;
