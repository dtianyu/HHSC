...
@NamedQueries({
    ...
    @NamedQuery(name = "SalesOrder.getRowCountBySalesman", query = "SELECT COUNT(s) FROM SalesOrder s WHERE s.salesman.id = :salesman "),
    @NamedQuery(name = "SalesOrder.findAll", query = "SELECT s FROM SalesOrder s ORDER BY s.salesstatus,s.id DESC"),
    ...
    @NamedQuery(name = "SalesOrder.findByItemId", query = "SELECT s FROM SalesOrder s WHERE s.itemid = :itemid"),
    @NamedQuery(name = "SalesOrder.findByColorId", query = "SELECT s FROM SalesOrder s WHERE s.colorid = :colorid"),
    @NamedQuery(name = "SalesOrder.findBySalesman", query = "SELECT s FROM SalesOrder s WHERE s.salesman.id = :salesman ORDER BY s.salesstatus,s.id DESC"),
    @NamedQuery(name = "SalesOrder.findBySalesstatus", query = "SELECT s FROM SalesOrder s WHERE s.salesstatus = :salesstatus ORDER BY s.salesstatus,s.id DESC"),
    @NamedQuery(name = "SalesOrder.findByHgstatus", query = "SELECT s FROM SalesOrder s WHERE s.hgstatus = :hgstatus ORDER BY s.hgstatus,s.id DESC"),
    @NamedQuery(name = "SalesOrder.findByZbstatus", query = "SELECT s FROM SalesOrder s WHERE s.zbstatus = :zbstatus ORDER BY s.zbstatus,s.id DESC"),
    @NamedQuery(name = "SalesOrder.findByPsstatus", query = "SELECT s FROM SalesOrder s WHERE s.psstatus = :psstatus ORDER BY s.psstatus,s.id DESC"),
    @NamedQuery(name = "SalesOrder.findByStatus", query = "SELECT s FROM SalesOrder s WHERE s.status = :status ORDER BY s.salesstatus,s.id DESC")})
