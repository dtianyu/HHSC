...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "SalesTransactionAdjust.getRowCount", query = "SELECT COUNT(s) FROM SalesTransactionAdjust s")
    ,
    @NamedQuery(name = "SalesTransactionAdjust.findAll", query = "SELECT s FROM SalesTransactionAdjust s")
    ,
    @NamedQuery(name = "SalesTransactionAdjust.findById", query = "SELECT s FROM SalesTransactionAdjust s WHERE s.id = :id")
    ,
    @NamedQuery(name = "SalesTransactionAdjust.findByFormid", query = "SELECT s FROM SalesTransactionAdjust s WHERE s.formid = :formid")
    ,
    @NamedQuery(name = "SalesTransactionAdjust.findByFormidAndSeq", query = "SELECT s FROM SalesTransactionAdjust s WHERE s.formid = :formid AND s.seq=:seq")
    ,
    @NamedQuery(name = "SalesTransactionAdjust.findByPId", query = "SELECT s FROM SalesTransactionAdjust s WHERE s.pid = :pid")
    ,
    @NamedQuery(name = "SalesTransactionAdjust.findByAbroad", query = "SELECT s FROM SalesTransactionAdjust s WHERE s.abroad = :abroad")
    ,
    @NamedQuery(name = "SalesTransactionAdjust.findByCustomerId", query = "SELECT s FROM SalesTransactionAdjust s WHERE s.customer.id = :customerid")
    ,
    @NamedQuery(name = "SalesTransactionAdjust.findBySalerid", query = "SELECT s FROM SalesTransactionAdjust s WHERE s.salerid = :salerid")
    ,
    @NamedQuery(name = "SalesTransactionAdjust.findByStatus", query = "SELECT s FROM SalesTransactionAdjust s WHERE s.status = :status")})
public class SalesTransactionAdjust extends SuperEntity {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SalesTransactionAdjust)) {
            return false;
        }
        SalesTransactionAdjust other = (SalesTransactionAdjust) object;
